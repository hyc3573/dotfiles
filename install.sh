...
for FILE in `ls -a -I .git -I . -I .. -I .xprofile -I init.el -I config.fish -I install.sh -I README.md -I README.org -I xmonad.hs -I wezterm.lua -I bindings -I config -I config.ini -I mpd.conf -I scimrc -I picom.conf -I contour.yml`
do
